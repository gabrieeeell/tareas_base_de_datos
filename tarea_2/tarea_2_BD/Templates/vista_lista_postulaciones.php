...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btn_actualizar_coordinador'])) {
    ...
    try {
        $upd_coord = $conexion->prepare("CALL sp_actualizar_coordinador_postulacion(:coord, :id)");
        $upd_coord->execute([
...
try {
    ...
    if ($f_reg_impacto !== '') {
        $condiciones[] = "R_I.ID_region = :reg_i";
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="id_reg_origen" class="form-select">
                                        ...
                                        <?php foreach($regiones as $r): ?>
                                            <option value="<?php echo $r['ID_region']; ?>" <?php echo ($f_reg_origen == $r['ID_region']) ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="id_reg_impacto" class="form-select">
                                        <option value="">Todas</option>
                                        <?php foreach($regiones as $r): ?>
                                            <option value="<?php echo $r['ID_region']; ?>" <?php echo ($f_reg_impacto == $r['ID_region']) ? 'selected' : ''; ?>>
                                                <?php echo $r['Nombre_region']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
